...
INSERT INTO GASTO(id,data_pagamento, descricao, fixo, tipo, valor, categoria_id, conta_id, pago, cartao_id) VALUES (1,'2021-05-01', 'Spotify', true, 'Gasto', 17.90, 6, 1, false, 1);
INSERT INTO GASTO(id,data_pagamento, descricao, fixo, tipo, valor, categoria_id, conta_id,pago, cartao_id) VALUES (2,'2021-05-01', 'Coxinha', true, 'Gasto', 17.90, 1, 1, false, 1);